      ...
      <main className="mx-auto flex max-w-lg flex-1 flex-col justify-center px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-full border border-border bg-card py-3.5 text-sm font-semibold text-foreground shadow-sm transition-colors hover:bg-muted disabled:opacity-50"
          >
